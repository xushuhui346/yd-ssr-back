 ...
 */
export declare function makeInvoker<T>(functionOrClass: ClassOrFunctionReturning<T>, opts?: ResolverOptions<T>): (methodToInvoke: string) => (ctx: any, ...rest: any[]) => any;
/**
 ...
 */
export declare function makeFunctionInvoker<T>(fn: FunctionReturning<T>, opts?: ResolverOptions<T>): (methodToInvoke: string) => (ctx: any, ...rest: any[]) => any;
/**
 ...
 * @return {(methodToInvoke: string) => (ctx) => void}
 */
export declare function makeClassInvoker<T>(Class: Constructor<T>, opts?: ResolverOptions<T>): (methodToInvoke: string) => (ctx: any, ...rest: any[]) => any;
/**
 ...
 * @return {(methodToInvoke: string) => (ctx) => void}
 */
export declare function makeResolverInvoker<T>(resolver: Resolver<T>): (methodToInvoke: string) => (ctx: any, ...rest: any[]) => any;
/**
