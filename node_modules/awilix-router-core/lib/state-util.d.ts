 ...
 */
export declare type Constructor = new (...args: Array<any>) => any;
/**
 ...
 * @param state
 */
export declare function rollUpState(state: IRouterConfigState): Map<string, IRouteConfig>;
/**
 ...
 * @param path
 */
export declare function addRoute(state: IRouterConfigState, methodName: string | null, path: string): IRouterConfigState;
/**
 ...
 * @param middleware
 */
export declare function addBeforeMiddleware(state: IRouterConfigState, methodName: string | null, middleware: MiddlewareParameter): IRouterConfigState;
/**
 ...
 * @param middleware
 */
export declare function addAfterMiddleware(state: IRouterConfigState, methodName: string | null, middleware: MiddlewareParameter): IRouterConfigState;
/**
 * Adds middleware that runs after the method on the specified config.
 *
 * @param state
 ...
 * @param value
 */
export declare function addHttpVerbs(state: IRouterConfigState, methodName: string | null, value: Array<HttpVerb>): IRouterConfigState;
/**
 ...
 * @param methodName
 */
export declare function getOrCreateConfig(state: IRouterConfigState, methodName: string | null): IRouteConfig;
/**
 ...
 */
export declare function updateConfig(state: IRouterConfigState, methodName: string | null, newConfig: Partial<IRouteConfig>): IRouterConfigState;
/**
